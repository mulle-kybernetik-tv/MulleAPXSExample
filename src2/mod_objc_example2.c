/* 
**  mod_objc_example2.c -- Apache sample objc_example module
...
**  by running:
**
**    $ apxs -c -i mod_objc_example2.c
**
**  Then activate it in Apache's apache2.conf file for instance
**  for the URL /objc_example in as follows:
**
**    #   apache2.conf
**    LoadModule objc_example2_module modules/mod_objc_example2.so
...
**  
**    The sample page from mod_objc_example2.c
*/ 
...
module AP_MODULE_DECLARE_DATA objc_example2_module = {
